...
#include "NX/H5Support/H5Support.hpp"
...
template NXH5SUPPORT_EXPORT std::vector<int8_t> DatasetIO::readAsVector<int8_t>() const;
template NXH5SUPPORT_EXPORT std::vector<int16_t> DatasetIO::readAsVector<int16_t>() const;
template NXH5SUPPORT_EXPORT std::vector<int32_t> DatasetIO::readAsVector<int32_t>() const;
template NXH5SUPPORT_EXPORT std::vector<int64_t> DatasetIO::readAsVector<int64_t>() const;
template NXH5SUPPORT_EXPORT std::vector<uint8_t> DatasetIO::readAsVector<uint8_t>() const;
template NXH5SUPPORT_EXPORT std::vector<uint16_t> DatasetIO::readAsVector<uint16_t>() const;
template NXH5SUPPORT_EXPORT std::vector<uint32_t> DatasetIO::readAsVector<uint32_t>() const;
template NXH5SUPPORT_EXPORT std::vector<uint64_t> DatasetIO::readAsVector<uint64_t>() const;
#ifdef __APPLE__
template NXH5SUPPORT_EXPORT std::vector<size_t> DatasetIO::readAsVector<size_t>() const;
#endif
template NXH5SUPPORT_EXPORT std::vector<float> DatasetIO::readAsVector<float>() const;
template NXH5SUPPORT_EXPORT std::vector<double> DatasetIO::readAsVector<double>() const;

template NXH5SUPPORT_EXPORT bool DatasetIO::readIntoSpan<int8_t>(nonstd::span<int8_t>&) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readIntoSpan<int16_t>(nonstd::span<int16_t>&) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readIntoSpan<int32_t>(nonstd::span<int32_t>&) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readIntoSpan<int64_t>(nonstd::span<int64_t>&) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readIntoSpan<uint8_t>(nonstd::span<uint8_t>&) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readIntoSpan<uint16_t>(nonstd::span<uint16_t>&) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readIntoSpan<uint32_t>(nonstd::span<uint32_t>&) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readIntoSpan<uint64_t>(nonstd::span<uint64_t>&) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readIntoSpan<bool>(nonstd::span<bool>&) const;
#ifdef __APPLE__
template NXH5SUPPORT_EXPORT bool DatasetIO::readIntoSpan<size_t>(nonstd::span<size_t>&) const;
#endif
template NXH5SUPPORT_EXPORT bool DatasetIO::readIntoSpan<float>(nonstd::span<float>&) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readIntoSpan<double>(nonstd::span<double>&) const;

template NXH5SUPPORT_EXPORT bool DatasetIO::readChunkIntoSpan<int8_t>(nonstd::span<int8_t>, nonstd::span<const hsize_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readChunkIntoSpan<int16_t>(nonstd::span<int16_t>, nonstd::span<const hsize_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readChunkIntoSpan<int32_t>(nonstd::span<int32_t>, nonstd::span<const hsize_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readChunkIntoSpan<int64_t>(nonstd::span<int64_t>, nonstd::span<const hsize_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readChunkIntoSpan<uint8_t>(nonstd::span<uint8_t>, nonstd::span<const hsize_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readChunkIntoSpan<uint16_t>(nonstd::span<uint16_t>, nonstd::span<const hsize_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readChunkIntoSpan<uint32_t>(nonstd::span<uint32_t>, nonstd::span<const hsize_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readChunkIntoSpan<uint64_t>(nonstd::span<uint64_t>, nonstd::span<const hsize_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readChunkIntoSpan<bool>(nonstd::span<bool>, nonstd::span<const hsize_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readChunkIntoSpan<char>(nonstd::span<char>, nonstd::span<const hsize_t>) const;
#ifdef __APPLE__
template NXH5SUPPORT_EXPORT bool DatasetIO::readChunkIntoSpan<size_t>(nonstd::span<size_t>, nonstd::span<const hsize_t>) const;
#endif
template NXH5SUPPORT_EXPORT bool DatasetIO::readChunkIntoSpan<float>(nonstd::span<float>, nonstd::span<const hsize_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetIO::readChunkIntoSpan<double>(nonstd::span<double>, nonstd::span<const hsize_t>) const;

template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeSpan<int8_t>(const DimsType&, nonstd::span<const int8_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeSpan<int16_t>(const DimsType&, nonstd::span<const int16_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeSpan<int32_t>(const DimsType&, nonstd::span<const int32_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeSpan<int64_t>(const DimsType&, nonstd::span<const int64_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeSpan<uint8_t>(const DimsType&, nonstd::span<const uint8_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeSpan<uint16_t>(const DimsType&, nonstd::span<const uint16_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeSpan<uint32_t>(const DimsType&, nonstd::span<const uint32_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeSpan<uint64_t>(const DimsType&, nonstd::span<const uint64_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeSpan<float>(const DimsType&, nonstd::span<const float>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeSpan<double>(const DimsType&, nonstd::span<const double>);

template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeChunk<int8_t>(const DimsType&, nonstd::span<const int8_t>, const DimsType&, nonstd::span<const hsize_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeChunk<int16_t>(const DimsType&, nonstd::span<const int16_t>, const DimsType&, nonstd::span<const hsize_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeChunk<int32_t>(const DimsType&, nonstd::span<const int32_t>, const DimsType&, nonstd::span<const hsize_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeChunk<int64_t>(const DimsType&, nonstd::span<const int64_t>, const DimsType&, nonstd::span<const hsize_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeChunk<uint8_t>(const DimsType&, nonstd::span<const uint8_t>, const DimsType&, nonstd::span<const hsize_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeChunk<uint16_t>(const DimsType&, nonstd::span<const uint16_t>, const DimsType&, nonstd::span<const hsize_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeChunk<uint32_t>(const DimsType&, nonstd::span<const uint32_t>, const DimsType&, nonstd::span<const hsize_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeChunk<uint64_t>(const DimsType&, nonstd::span<const uint64_t>, const DimsType&, nonstd::span<const hsize_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeChunk<float>(const DimsType&, nonstd::span<const float>, const DimsType&, nonstd::span<const hsize_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeChunk<double>(const DimsType&, nonstd::span<const double>, const DimsType&, nonstd::span<const hsize_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeChunk<bool>(const DimsType&, nonstd::span<const bool>, const DimsType&, nonstd::span<const hsize_t>);
template NXH5SUPPORT_EXPORT ErrorType DatasetIO::writeChunk<char>(const DimsType&, nonstd::span<const char>, const DimsType&, nonstd::span<const hsize_t>);
} // namespace NX::H5Support
