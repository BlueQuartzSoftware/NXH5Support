...
#include "NX/H5Support/IO/ObjectIO.hpp"
...
class NXH5SUPPORT_EXPORT DatasetIO : public ObjectIO
{
public:
  ...
  /**
   * @brief Returns a complex::DataType enum representation of the attribute's
