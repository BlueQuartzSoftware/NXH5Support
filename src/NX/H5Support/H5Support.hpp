 ...
 */
inline bool NXH5SUPPORT_EXPORT IsGroup(hid_t nodeId, const std::string& objectName)
{
...
herr_t NXH5SUPPORT_EXPORT FindAttr(hid_t /*locationId*/, const char* name, const H5A_info_t* /*info*/, void* opData);
 ...
 */
herr_t NXH5SUPPORT_EXPORT FindAttribute(hid_t locationId, const std::string& attributeName);
 ...
 * @return std::string
 */
std::string NXH5SUPPORT_EXPORT HdfClassTypeAsStr(hid_t classType);
 ...
 * @return
 */
hid_t NXH5SUPPORT_EXPORT getDatasetType(hid_t locationId, const std::string& datasetName);
#endif
 ...
 */
inline std::string NXH5SUPPORT_EXPORT GetObjectPath(hid_t locationId)
{
  H5SUPPORT_MUTEX_LOCK()
 ...
 * @return
 */
inline hid_t NXH5SUPPORT_EXPORT GetDatasetType(hid_t locationId, const std::string& datasetName)
{
  H5SUPPORT_MUTEX_LOCK()
