...
// declare readAsValue
template NXH5SUPPORT_EXPORT int8_t AttributeReader::readAsValue<int8_t>() const;
template NXH5SUPPORT_EXPORT int16_t AttributeReader::readAsValue<int16_t>() const;
template NXH5SUPPORT_EXPORT int32_t AttributeReader::readAsValue<int32_t>() const;
template NXH5SUPPORT_EXPORT int64_t AttributeReader::readAsValue<int64_t>() const;
template NXH5SUPPORT_EXPORT uint8_t AttributeReader::readAsValue<uint8_t>() const;
template NXH5SUPPORT_EXPORT uint16_t AttributeReader::readAsValue<uint16_t>() const;
template NXH5SUPPORT_EXPORT uint32_t AttributeReader::readAsValue<uint32_t>() const;
template NXH5SUPPORT_EXPORT uint64_t AttributeReader::readAsValue<uint64_t>() const;
template NXH5SUPPORT_EXPORT float AttributeReader::readAsValue<float>() const;
template NXH5SUPPORT_EXPORT double AttributeReader::readAsValue<double>() const;
} // namespace NX::H5Support
