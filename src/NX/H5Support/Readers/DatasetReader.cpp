...
template NXH5SUPPORT_EXPORT std::vector<int8_t> DatasetReader::readAsVector<int8_t>() const;
template NXH5SUPPORT_EXPORT std::vector<int16_t> DatasetReader::readAsVector<int16_t>() const;
template NXH5SUPPORT_EXPORT std::vector<int32_t> DatasetReader::readAsVector<int32_t>() const;
template NXH5SUPPORT_EXPORT std::vector<int64_t> DatasetReader::readAsVector<int64_t>() const;
template NXH5SUPPORT_EXPORT std::vector<uint8_t> DatasetReader::readAsVector<uint8_t>() const;
template NXH5SUPPORT_EXPORT std::vector<uint16_t> DatasetReader::readAsVector<uint16_t>() const;
template NXH5SUPPORT_EXPORT std::vector<uint32_t> DatasetReader::readAsVector<uint32_t>() const;
template NXH5SUPPORT_EXPORT std::vector<uint64_t> DatasetReader::readAsVector<uint64_t>() const;
#ifdef __APPLE__
template NXH5SUPPORT_EXPORT std::vector<size_t> DatasetReader::readAsVector<size_t>() const;
#endif
template NXH5SUPPORT_EXPORT std::vector<float> DatasetReader::readAsVector<float>() const;
template NXH5SUPPORT_EXPORT std::vector<double> DatasetReader::readAsVector<double>() const;

template NXH5SUPPORT_EXPORT bool DatasetReader::readIntoSpan<int8_t>(nonstd::span<int8_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetReader::readIntoSpan<int16_t>(nonstd::span<int16_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetReader::readIntoSpan<int32_t>(nonstd::span<int32_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetReader::readIntoSpan<int64_t>(nonstd::span<int64_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetReader::readIntoSpan<uint8_t>(nonstd::span<uint8_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetReader::readIntoSpan<uint16_t>(nonstd::span<uint16_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetReader::readIntoSpan<uint32_t>(nonstd::span<uint32_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetReader::readIntoSpan<uint64_t>(nonstd::span<uint64_t>) const;
template NXH5SUPPORT_EXPORT bool DatasetReader::readIntoSpan<bool>(nonstd::span<bool>) const;
#ifdef __APPLE__
template NXH5SUPPORT_EXPORT bool DatasetReader::readIntoSpan<size_t>(nonstd::span<size_t>) const;
#endif
template NXH5SUPPORT_EXPORT bool DatasetReader::readIntoSpan<float>(nonstd::span<float>) const;
template NXH5SUPPORT_EXPORT bool DatasetReader::readIntoSpan<double>(nonstd::span<double>) const;
} // namespace NX::H5Support
