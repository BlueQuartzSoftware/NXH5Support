...
#include "NXH5Support/Readers/ObjectReader.hpp"

#include "NXCommon/Result.hpp"

namespace NX::H5Support
{
class NXH5SUPPORT_EXPORT DatasetReader : public ObjectReader
{
public:
  /**
  ...
  /**
   * @brief Returns a NX::DataType enum representation of the attribute's
   * type or an error if there is no conversion.
   * @return DataType
   */
  Common::Result<Type> getDataType() const;
