...
// declare readAsValue
template NXH5SUPPORT_EXPORT int8_t AttributeIO::readAsValue<int8_t>() const;
template NXH5SUPPORT_EXPORT int16_t AttributeIO::readAsValue<int16_t>() const;
template NXH5SUPPORT_EXPORT int32_t AttributeIO::readAsValue<int32_t>() const;
template NXH5SUPPORT_EXPORT int64_t AttributeIO::readAsValue<int64_t>() const;
template NXH5SUPPORT_EXPORT uint8_t AttributeIO::readAsValue<uint8_t>() const;
template NXH5SUPPORT_EXPORT uint16_t AttributeIO::readAsValue<uint16_t>() const;
template NXH5SUPPORT_EXPORT uint32_t AttributeIO::readAsValue<uint32_t>() const;
template NXH5SUPPORT_EXPORT uint64_t AttributeIO::readAsValue<uint64_t>() const;
template NXH5SUPPORT_EXPORT float AttributeIO::readAsValue<float>() const;
template NXH5SUPPORT_EXPORT double AttributeIO::readAsValue<double>() const;
